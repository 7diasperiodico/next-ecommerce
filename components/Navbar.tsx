              ...
              <DropdownMenuContent className='w-56 ' align='end' forceMount>
                <DropdownMenuLabel className='font-normal'>
                  <div className='flex flex-col space-y-1'>
                    <p className='text-sm font-medium leading-none bg-gradient-to-r from-purple-500 via-pink-500 to-red-500 bg-clip-text text-transparent'>
                      {
                ...
                <DropdownMenuItem className='focus:text-purple-600'>
                  <Link href="/profile" className='flex-full'>
                    ...
                    {user && (
                      <div className='flex items-center px-5 mb-3'>
                        ...
                        {user ? (
                          ...
                          <button 
                          onClick={handleLogout}
                          className='block px-3 py-2 rounded-md text-base font-medium text-gray-500 hover:text-white hover:bg-purple-500 w-ful text-left cursor-pointer'
                          >
                          Log out
                          </button>
                          </div>
